              ...
              <div className="card2 mb-3 mx-auto" style={{ maxWidth: '512px' , color:'white', boxShadow:'5px 5px 10px rgb(0, 0, 0)'}}>
                <h2 fontFamily="Arial"><b>Upload File</b></h2>
                  <form onSubmit={(event) => {
                    ...
                    {/*<button type="submit" className="button button2" onClick={() => window.open("http://127.0.0.1:45005/ipfs/bafybeiequgo72mrvuml56j4gk7crewig5bavumrrzhkqbim6b3s2yqi7ty/#/files")}>
  <b>Upload</b>
                </button>*/}
